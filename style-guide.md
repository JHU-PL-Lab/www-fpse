...
Here are the FPSE guidelines for writing well-formatted, good-looking OCaml code. [Here](./coding_guidelines.html) are the guidelines for writing _good_ code, not just _good-looking_ code, which we will cover later in the course.
