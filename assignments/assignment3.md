...
* See the [Modules](https://pl.cs.jhu.edu/fpse/lecture/modules.html) lecture for information on filling in the module signatures (i.e. writing the `.ml` files such that they compile along with the `.mli` files).
