...
Grades will be computed approximately as follows: 45% for projects, 20% for homeworks, 10% for the in-class exercises, and 25% for the Exam.  There is no curve but the cutoffs may shift based on assignment difficulty; you can assume they will probably be at or close to the standard 90-80-70 for A/B/C based on previous years cutoffs.
...
For the programming exercises you will not learn how to program in OCaml if you just rely on LLMs to write your code.  So, while you are welcome to use LLMs as a reference, it is forbidden to ask them to solve a homework problem.  For the projects you can use LLMs more extensively, but you *must* thoroughly understand every line of code in your project (yes part of the project grade will be your understanding of your code).

Please make sure to consult the course [Academic Integrity Policy](integrity.html) on what is legitimate, it is spelled out in more detail there.
